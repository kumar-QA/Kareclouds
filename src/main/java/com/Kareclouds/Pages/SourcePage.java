...
public class SourcePage extends GenericPage{
	...
	WebElement AddSourceBtn;
	@FindBy(xpath="//form[@id='formadd']//input[@name='source']")
	...
	public void AddSourceseForm(String src,String des) {
		AddSourceBtn.click();
		sourcename.sendKeys(src);
